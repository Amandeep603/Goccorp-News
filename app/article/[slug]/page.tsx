        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="pt-5 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-navy/10 text-navy font-bold flex items-center justify-center text-sm border border-navy/20">
                {authorName
                  .split(" ")
                  .map((n) => n[0])
                  .join("")
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-[#1877F2] hover:text-white text-gray-600 flex items-center justify-center transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-black hover:text-white text-gray-600 flex items-center justify-center transition-all cursor-pointer"
              >
                <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-[#0A66C2] hover:text-white text-gray-600 flex items-center justify-center transition-all cursor-pointer"
              >
                <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-[#25D366] hover:text-white text-gray-600 flex items-center justify-center transition-all cursor-pointer"
              >
